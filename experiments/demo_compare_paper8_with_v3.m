...
% Compare Fig.1-Fig.8 paper experiments with FGD replacing AdaBoost lines.
    ...
    output_dir = fullfile(pwd, 'results_paper8_v3');
    ...
    switch lower(mode_str)
        case 'quick'
            ...
            rootloop_opts = struct( ...
                ...
                'smoothing_margin', 8, ...
                'base_data_blend', 0.18, ...
                'residual_blend_strength', 0.62, ...
                'quant_feedback_step', 0.95, ...
                'update_relaxation', 0.72, ...
                'reweight_floor', 0.20, ...
                'residual_power', 1.0, ...
                'residual_tol', 3e-3, ...
                'theta_tol_deg', 0.05, ...
        ...
        case 'full'
            ...
            rootloop_opts = struct( ...
                ...
                'smooth_boundary_ratio', 0.22, ...
                'smoothing_margin', 8, ...
                'base_data_blend', 0.16, ...
                'residual_blend_strength', 0.68, ...
                'quant_feedback_step', 1.00, ...
                'update_relaxation', 0.78, ...
                'reweight_floor', 0.18, ...
                'residual_power', 1.0, ...
                'residual_tol', 2e-3, ...
                'theta_tol_deg', 0.03, ...
